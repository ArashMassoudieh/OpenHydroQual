...
\begin{longtable}{@{}clcp{0.42\textwidth}ccccc@{}}
\caption*{\textbf{HDS-5 Table A.1} --- constants for inlet control equations, circular and rectangular shapes.}\\
\toprule
\textbf{Chart} & \textbf{Shape / Material} & \textbf{Scale} & \textbf{Inlet configuration}
 & \textbf{Form} & $K$ & $M$ & $c$ & $Y$\\
\midrule
\endfirsthead
\toprule
