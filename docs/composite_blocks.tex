...
\item \textbf{Each file is loaded once,} identified by its file name. Adding
\file{unsaturated\_soil.json} by its full path and then a plugin that requires
it by name parses it a single time.
