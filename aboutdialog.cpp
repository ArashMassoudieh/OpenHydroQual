    ...
    QDialog(parent)
{
    ...
    SetLicenseText(
        ...
        "<p><b>Free for All Commercial Activities:</b> You may freely use this software for "
        "any commercial purpose, including consulting services, engineering design, research, "
        "and business operations at no cost under the AGPL v3.0 license.</p>"
        "<p><b>Commercial License Required For:</b> If you wish to incorporate this software "
        "into a proprietary commercial product, create closed-source derivative works, or "
        "distribute it as part of a commercial software package, you must purchase a commercial license.</p>"
