...
struct solversettings
{
    ...
    /// gate openings, imposed heads, inflows, ET inputs and precipitation
    /// (timestep_clamp_series = "All time series"; needed where fast non-rain
    /// forcing matters, e.g. imposed gate operations). The codegen kernel reads
    /// the same setting.
    bool clamp_dt_to_all_timeseries = false;
