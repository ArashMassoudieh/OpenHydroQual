...
template<class T> double diff(CTimeSeries<T> &BTC_p, CTimeSeries<T> &BTC_d);
template<class T> double diff_abs(CTimeSeries<T> &BTC_p, CTimeSeries<T> &BTC_d);
template<class T> double diff_log(CTimeSeries<T> &BTC_p, CTimeSeries<T> &BTC_d, double lowlim);
template<class T> double diff_norm(CTimeSeries<T> &BTC_p, CTimeSeries<T> &BTC_d);
template<class T> double diff(CTimeSeries<T> BTC_p, CTimeSeries<T> BTC_d, int scale);
template<class T> double diff(CTimeSeries<T> BTC_p, CTimeSeries<T> BTC_d, CTimeSeries<T> Q);
template<class T> double diff2(CTimeSeries<T> *BTC_p, CTimeSeries<T> BTC_d);
template<class T> double diff2(CTimeSeries<T> BTC_p, CTimeSeries<T> *BTC_d);
template<class T> double diff2(const CTimeSeries<T> &BTC_p, const CTimeSeries<T> &BTC_d);
template<class T> double diff_mixed(CTimeSeries<T> &BTC_p, CTimeSeries<T> &BTC_d, double lowlim, double std_n, double std_ln);
template<class T> double ADD(CTimeSeries<T> &BTC_p, CTimeSeries<T> &BTC_d);
template<class T> double diff_relative(CTimeSeries<T> &BTC_p, CTimeSeries<T> &BTC_d, double m);
template<class T> double R2(CTimeSeries<T> BTC_p, CTimeSeries<T> BTC_d);
template<class T> double R(CTimeSeries<T> BTC_p, CTimeSeries<T> BTC_d, int nlimit);
...
template<class T> double XYbar(CTimeSeries<T>& BTC_p, CTimeSeries<T> &BTC_d);
template<class T> double X2bar(CTimeSeries<T>& BTC_p, CTimeSeries<T> &BTC_d);
template<class T> double Y2bar(CTimeSeries<T>& BTC_p, CTimeSeries<T> &BTC_d);
template<class T> double Ybar(CTimeSeries<T> &BTC_p, CTimeSeries<T> &BTC_d);
template<class T> double Xbar(CTimeSeries<T> &BTC_p, CTimeSeries<T> &BTC_d);
...
template<class T> double sum_interpolate(vector<CTimeSeries<T>>, double t);
template<class T> double R2_c(CTimeSeries<T> BTC_p, CTimeSeries<T> BTC_d);
template<class T> double norm2(CTimeSeries<T> BTC1);
